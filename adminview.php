...
$sql = "SELECT aid, name, email,password, phone, address FROM admin";
...
<body>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="editadmin.php?id=<?php echo $row['aid']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="deleteadmin.php?id=<?php echo urlencode($row['aid']); ?>" class="btn custom-btn-delete btn-sm" onclick="return confirm('Are you sure you want to delete this admin?');">Delete</a>
    ...
    <a href="addadmin.php" class="btn custom-btn-add">Add New Admin</a>
</div>
    </div>
